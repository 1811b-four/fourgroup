...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAIkWKDlzxriB2Z";  //你的AccessKey ID 在网站上！隐私关系我这里无法展示
    private String accessKeySecret = "neGx0jQO6x4kPAAEOOMwFnkII33h9G"; //你的Access Key Secret 隐私关系我这里无法展示
    // 空间
    private String bucketName = "theshowqwb";
    // 文件存储目录
    private String filedir = "秋风/";
